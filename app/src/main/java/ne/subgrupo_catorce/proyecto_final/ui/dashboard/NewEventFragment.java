...
public class NewEventFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Spinner spinner = findViewById(R.id.destinos);
...
*/
                ...
                long id=dbEventos.insertaEventos(txtNombre.getEditText().getText().toString(), txtTitulo.getEditText().getText().toString(), "", txtDescripcion.getEditText().getText().toString(), 0.0,0.0);
